		...
		<html:form method="get">
			...
			<table border="0" align="center" cellpadding="6">
				...
				<tr>
					...
					<td align="left">
						<html:select property="comment" >
							<html:option value=""> - ทั้งหมด -</html:option>
							<html:options collection="commentList" property="value" labelProperty="desc" />
						</html:select>
					</td>
				</tr>
				<tr>
					...
					<td>
						สถานะการพิมพ์ใบแจ้งหนี้
					</td>
					<td align="left">
						<html:select property="billflag" >
							<html:option value=""> - ทั้งหมด -</html:option>
							<html:options collection="billFlagList" property="value" labelProperty="desc" />
						</html:select>
					</td>
				</tr>
				<tr>
