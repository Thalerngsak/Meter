...
/**
 * A data access object (DAO) providing persistence and search support for User entities. Transaction control of the save(), update() and delete()
 ...
 * 
 * @see com.pwa.data.model.user.User
...
public class UserDAO extends BaseHibernateDAO {
	...
	public User findById(java.lang.String id) {
		...
		try {
			User instance = (User) getSession().get("com.pwa.data.model.user.User", id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List findByExample(User instance) {
		...
		try {
			List results = getSession().createCriteria("com.pwa.data.model.user.User").add(Example.create(instance)).list();
