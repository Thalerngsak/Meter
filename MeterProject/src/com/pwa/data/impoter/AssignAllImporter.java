...
public class AssignAllImporter {
	static Logger log = Logger.getLogger(AssignAllImporter.class);

	public static long run(String type, String filename, Date tranDate, MessageList msgList) throws Exception {
		long r = 0;
		ArrayList inputList = getInputFileDataList(type, filename, tranDate); // read file and build to list
	...
	public static ArrayList getInputFileDataList(String type, String filename, Date tranDate) throws Exception {
...
//					}
	...
	private static Detail getDetail(String type, String[] parts, Date tranDate) throws Exception {
...
//		}
    ...
    public static List<Head> getHeadByDate(String assignDate,String br,MessageList msgList) throws Exception{
    	Connection con = null;
		PreparedStatement p = null;
		ResultSet rs = null;
        String sql = "select * from head where assigndate = "+assignDate+" and br = "+br;
        List<Head> r = new ArrayList<Head>();
		try {
    ...
    public static List<Head> getHeadByDateAll(String assignDate,MessageList msgList) throws Exception{
    	Connection con = null;
		PreparedStatement p = null;
		ResultSet rs = null;
        String sql = "select * from head where assigndate = "+assignDate;
        List<Head> r = new ArrayList<Head>();
		try {
			con = DBHelper.getDBConnection();
			p = con.prepareStatement(sql);
